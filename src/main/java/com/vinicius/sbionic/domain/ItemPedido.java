...
public class ItemPedido implements Serializable{
	...
	// Setar as classes vindas no parametro do construtor para a classe PK receber os objetos
	// que no caso foi Pedido e Produto
	...
	public String toString() {
		// NumberFormat para formatar dinheiro com o país específico
