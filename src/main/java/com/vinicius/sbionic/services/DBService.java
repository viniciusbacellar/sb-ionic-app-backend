...
// Classe responsável por instanciar os dados no banco de dados na configuração de teste
@Service
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "viniciusruas76@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
